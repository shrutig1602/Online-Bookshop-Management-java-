 ...
 %>    
        ...
        <div class="col-md-3 mt-4 mx-3">
            <div class="list-group">
                ...
                <a href="#" class="list-group-item list-group-item-action">User Details And Delete User</a>
                <a href="#" class="list-group-item list-group-item-action">Messages Received</a>
                <a href="#" class="list-group-item list-group-item-action">Orders Received</a>
                <a href="#" class="list-group-item list-group-item-action">Canceled Orders </a>
                <a href="#" class="list-group-item list-group-item-action">Delivered Orders</a>
        ...
        <div class="col-md-8 mt-4">
            ...
            ResultSet rs=st.executeQuery("select * from product where (active='YES') and ((name like '%"+search+"%') or (category like '%"+search+"%') or (authorName like '%"+search+"%'))");
           while(rs.next())
           {
                    %>
                    ...
                    <div class="col_3 product-card text-center p-3 mr-0.5">
                        ...
                        <div class="float-left" style="width:100%"><a class="btn btn-primary px-5 my-1 ml-1 float-left" href="">Edit   <i class="fas fa-edit"></i></a></div>
