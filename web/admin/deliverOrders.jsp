...
<body>
    ...
    <header>
             ...
             <div class="header-1">              
                 ...
                 <span style="font-size: 2rem;font-weight: 700">ORDERS DELIVERED<i class="fas fa-truck" style="font-size: 2em;padding: 0.5em"></i>  </span>
    ...
    <h2 class="text-center p-3 m-3" style="background: #e2e2e2;color:#990000; font-weight: 700">ORDERS DELIVERED</h2>
    <br><br>
