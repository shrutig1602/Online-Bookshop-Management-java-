...
try {
        ...
        //selecting the product with specified ID from database   //THIS IS MANDATORY
        ...
        while(rs.next())
        {
         ...
         //if product is already there in cart then update
        ...
        //if product doesnt already exist in cart then insert the product
        if(z==0)
        {
