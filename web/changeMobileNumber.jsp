...
<header>
             ...
             <div class="header-1">              
                 ...
                 <span style="font-size: 2rem;font-weight: 700">CHANGE YOUR MOBILE NUMBER <i class="fas fa-mobile-alt" style="font-size: 2em;padding: 0.5em"></i></span>
...
<%
  ...
  <strong>Yeyy!</strong> Your Mobile Number successfully changed!
...
<div class="container">
  ...
  <div class="form-group text-center m-5">
    <label for="mobileNumber">Enter Your New Mobile Number</label>
    <input type="number" class="form-control form-control-lg" id="mobileNumber" name="mobileNumber" placeholder="Enter Your New Mobile Number">   
  </div>
  ...
  <div class="form-group text-center m-5">
    ...
    <div class="text-center">
        <button type="submit" class="btn btn-success px-5" style="font-size: 2rem">SAVE <i class='far fa-arrow-alt-circle-right'></i></button>
    </div>
